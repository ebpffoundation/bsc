...
3. Participation: Participate and lead in the ongoing development of the eBPF paradigm. All projects are assigned a [Mentor](project-mentors.md) to assist in the integration of your project to the Foundation and growth beyond that.
...
and the [Technical Charter template](https://lists.confidentialcomputing.io/g/main/files/BSC/Project%20Submissions/Technical%20Charter%20%28custom+data%29%20--%20LF%20Projects,%20LLC%204-10-2019%20FINAL%20%2811%29.docx)).
...
BSC representatives if voting by email, unless a project is being accepted
at or moved to either the Graduation or Emeritus stage, in which a vote of
two-thirds of all BSC representatives is required.

The BSC will determine the appropriate initial stage for the project.
...
by the BSC), and a signed Project Contribution Agreement that assigns trademarks
to LF Projects, LLC.
...
Projects can create multiple subordinate projects that are governed under the structure agreed on and accepted by the BSC.
...
Every Foundation project has an associated maturity level. Proposed projects should state their preferred maturity level.  There are four maturity levels under this Project Progression Policy:

* Sandbox - projects looking for a foundation with minimal initial resource requirements;
* Incubation - growing projects that are targeting particular growth metrics and looking for resources from the Foundation;
...
The Sandbox stage is for projects that the BSC believes are, or have the potential to be, important to the ecosystem of Technical Projects or the ecosystem of the Foundation as a whole. They may be early-stage projects just getting started, or they may be long-established projects with minimal resource needs. The Sandbox stage provides a beneficial, neutral home for these projects in order to foster collaborative development and provide a path to deeper alignment with other Foundation projects via the graduation process.
...
2.	Independent projects that fit within the Foundation mission and provide potential for a novel approach to existing functional areas (or are an attempt to meet an unfulfilled need).
3.	Projects commissioned or sanctioned by the Foundation.

**Expectations**

End users should evaluate Sandbox projects with care, as this stage does not set requirements for community size, governance, or production readiness. Sandbox projects will receive minimal support from the Foundation. Projects will be reviewed on an annual basis; they may also request a status review by submitting a report to the BSC.

**Acceptance Criteria**

To be considered for the Sandbox Stage, the project must meet the following requirements:
* 1 representative designated by the BSC that will serve as a sponsor to champion the project & provide mentorship as needed
* A presentation to at the meeting of the BSC
...
The Incubation stage is for projects that are interested in reaching the Graduation stage, and have identified a [growth plan](growth-plans.md) for doing so. Incubation stage projects will receive mentorship from the BSC and are expected to actively develop their community of contributors, governance, project documentation, and other variables identified in the growth plan that factor into broad success and adoption.

In order to support their active development, projects in the Incubation stage have a higher level of access to Foundation resources as provided by the Governing Board of the Foundation. A project's progress toward its growth plan goals will be reviewed on a yearly basis, and the BSC may move a project to the Sandbox stage if progress on the plan drops off or stalls.
...
4.	Projects that need more active support from the Foundation or BSC mentorship in order to reach their goals.
 ...
 * Development of a growth plan, to be done in conjunction with their [project mentor(s)](project-mentors.md) at the BSC.
 * Document that it is being used successfully in production by at least two independent end-user organizations which, in the BSC's judgement, are of adequate quality and scope.
 * Demonstrate a substantial, in the opinion of the BSC, ongoing flow of commits and merged contributions.
 * Demonstrate that the current level of community participation is sufficient to meet the goals outlined in the growth plan.
 * Since these metrics can vary significantly depending on the type, scope and size of a project, the BSC has final judgement over the level of activity that is adequate to meet these criteria.
 ...
 * Receive a two-thirds supermajority vote of the BSC to move to Incubation stage.
...
Graduation stage projects are "BSC Projects" under the
...
They are eligible to receive ongoing support from the Foundation as determined by the Governing Board, and are expected to cross promote the Foundation along with their activities.
...
* Other metrics as defined by the applying Project during the application process in cooperation with the BSC.
* Receive a supermajority vote from the BSC to move to Graduation stage.
...
Emeritus projects are projects which the BSC or a project's maintainers feel have reached or are nearing end-of-life. Emeritus projects may have contributed to the ecosystem, but are not necessarily recommended for modern development as there may be more actively maintained choices. The Foundation appreciates the contributions of these projects and their communities, and the role they have played in moving the ecosystem forward.
...
Projects in this stage are not in active development. Their maintainers may infrequently monitor their repositories, and may only push updates to address security issues, if at all. Emeritus projects should clearly state their status and what any user or contributor should expect in terms of response or support. If there is an alternative project the maintainers recommend, it should be listed as well. The Foundation will continue to hold the IP and any trademarks and domains, but the project is not expected to draw on Foundation resources.

**Acceptance Criteria**

Projects may be granted Emeritus status via a vote of two-thirds of the representatives of the BSC.
...
2. Review the project's progression status to determine whether the project
   ...
   at the current level? Is any action needed from the BSC (e.g., change in
